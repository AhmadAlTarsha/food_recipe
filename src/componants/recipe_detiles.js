...
if (!Nutritional) {
  setShow("hide")
      ...
      }} className='Nutritional_button' >{Show} Nutritional Value  </button> </div><h3>see the Recipe in the site</h3></div>{Nutritional && <Nutritional_val currentRecipes={currentRecipes}/>}<div></div></div></div>
